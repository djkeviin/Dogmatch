...
try {
    ...
    echo "Actualizando estructura de las tablas...\n\n";

    // Ejecutar script de actualización
    $sqlFile = file_get_contents(__DIR__ . '/../sql/actualizar_tablas.sql');
    ...
    echo "Las tablas han sido actualizadas con los nuevos campos.\n";
